...
// Include CSS
// wp_enqueue_style( 'bootstrap-theme.min', get_template_directory_uri() . '/css/bootstrap-theme.min.css',false,'1.1','all');
// wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/css/bootstrap.css',false,'1.1','all');
// wp_enqueue_style( 'bootstrap-theme', get_template_directory_uri() . '/css/bootstrap-theme.css',false,'1.1','all');
...
wp_enqueue_style( 'font-awesome.min', get_template_directory_uri() . '/css/font-awesome.min.css',false,'1.1','all');
wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/css/font-awesome.css',false,'1.1','all');
wp_enqueue_style( 'magnific-popup', get_template_directory_uri() . '/css/magnific-popup.css',false,'1.1','all');
wp_enqueue_style( 'creative.min', get_template_directory_uri() . '/css/creative.min.css',false,'1.1','all');



wp_enqueue_script( 'scrollreveal.min', get_template_directory_uri() . '/js/scrollreveal.min.js', array(), '3.7.3', true );
wp_enqueue_script( 'magnific-popup.min', get_template_directory_uri() . '/js/jquery.magnific-popup.min.js', array(), '3.7.3', true );
wp_enqueue_script( 'creative.min', get_template_directory_uri() . '/js/creative.min.js', array(), '3.7.3', true );
